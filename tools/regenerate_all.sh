...
echo "[1/9] WP5 campaign Monte Carlo (N=500 x 2 catalogs)"
"$BUILD/adsc_campaign" 500 generated
echo "[2/9] WP6 cost model + FoM (kit sweep, consumes WP5)"
"$BUILD/adsc_cost" 500 generated
echo "[3/9] WP3 decay-trade CSV"
"$BUILD/decay_trade" generated
echo "[4/9] T6 small-debris flux sweep"
"$BUILD/flux_sweep" generated
echo "[5/9] WP7 reference metrics (WP1/F1/WP2/WP3/WP4 pinned numbers)"
"$BUILD/sim_metrics" generated
echo "[6/9] WP10c keep-out violation forensics (read-only replay of WP5)"
python3 tools/forensics/make_forensics.py
echo "[7/9] WP7a visualization pack"
python3 tools/viz/make_viz.py . generated/viz
echo "[8/9] WP8 compliance precheck + matrix (not legal advice)"
python3 tools/compliance/check_compliance.py
python3 tools/compliance/generate_matrix.py
echo "[9/9] WP7 evidence pack"
